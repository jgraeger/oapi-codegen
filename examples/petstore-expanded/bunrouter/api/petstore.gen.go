...
type ServerInterface interface {
	// Returns all pets
	// (GET /pets)
	FindPets(w http.ResponseWriter, req bunrouter.Request, params FindPetsParams) error
	// Creates a new pet
	// (POST /pets)
	AddPet(w http.ResponseWriter, req bunrouter.Request) error
	// Deletes a pet by ID
	// (DELETE /pets/{id})
	DeletePet(w http.ResponseWriter, req bunrouter.Request, id int64) error
	// Returns a pet by ID
	// (GET /pets/{id})
	FindPetByID(w http.ResponseWriter, req bunrouter.Request, id int64) error
}
...
func (siw *ServerInterfaceWrapper) FindPets(w http.ResponseWriter, r bunrouter.Request) error {
	ctx := r.Context()
	var err error
	...
	if err != nil {
		return &InvalidParamFormatError{ParamName: "tags", Err: err}
	}
	...
	if err != nil {
		return &InvalidParamFormatError{ParamName: "limit", Err: err}
	}

	err = siw.Handler.FindPets(w, r.WithContext(ctx), params)
	return err
}

// AddPet operation middleware
func (siw *ServerInterfaceWrapper) AddPet(w http.ResponseWriter, r bunrouter.Request) error {
	ctx := r.Context()
	var err error

	err = siw.Handler.AddPet(w, r.WithContext(ctx))
	return err
}

// DeletePet operation middleware
func (siw *ServerInterfaceWrapper) DeletePet(w http.ResponseWriter, r bunrouter.Request) error {
	ctx := r.Context()
	var err error
	// ------------- Path parameter "id" -------------
	var id int64

	err = runtime.BindStyledParameterWithLocation("simple", false, "id", runtime.ParamLocationPath, r.Param("id"), &id)
	if err != nil {
		return &InvalidParamFormatError{ParamName: "id", Err: err}
	}

	err = siw.Handler.DeletePet(w, r.WithContext(ctx), id)
	return err
}

// FindPetByID operation middleware
func (siw *ServerInterfaceWrapper) FindPetByID(w http.ResponseWriter, r bunrouter.Request) error {
	ctx := r.Context()
	var err error
	// ------------- Path parameter "id" -------------
	var id int64
	...
	err = siw.Handler.FindPetByID(w, r.WithContext(ctx), id)
	return err
}
